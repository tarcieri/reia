...
function_calls_test_() ->
  [ % Local Calls
    ...
    ?_assertEqual([{local_call,1,func1,[],{lambda,1,[],[{integer,1,69}]}}],
                                            parse(" func1 { 69 } ")),
    ?_assertEqual([{local_call,1,func1,[],{lambda,1,[{var,1,parm}],[{integer,1,69}]}}],
                                            parse(" func1 { | parm | 69 } ")),
    ?_assertEqual([{local_call,1,func1,[{integer,1,27}],{lambda,1,[],[]}}],
                                            parse(" func1 ( 27 ) { } ")),
    ?_assertEqual([{local_call,1,func1,[{integer,1,27}],{lambda,1,[],[{integer,1,69}]}}],
                                            parse(" func1 ( 27 ) { 69 } ")),
    ?_assertEqual([{local_call,1,func1,[{integer,1,27}],{lambda,1,[{var,1,parm}],[{integer,1,69}]}}],
                                            parse(" func1 ( 27 ) { | parm | 69 } ")),
    ?_assertEqual([{local_call,1,func1,[],{lambda,1,[],[{integer,1,77}]}}],
                                            parse(" func1 do 77 end ")),
    ?_assertEqual([{local_call,1,func1,[],{lambda,1,[{var,1,parm}],[{integer,1,77}]}}],
                                            parse(" func1 do | parm | 77 end ")),
    ?_assertEqual([{local_call,1,func1,[],{lambda,1,[],[{integer,2,77}]}}],
                                            parse(" func1 do \n 77 \n end \n ")),
    ?_assertEqual([{local_call,1,func1,[{integer,1,27}],{lambda,1,[],[{integer,1,77}]}}],
                                            parse(" func1 ( 27 ) do 77 end ")),
    ?_assertEqual([{local_call,1,func1,[{var,1,abc}],{lambda,1,[{var,1,parm}],[{integer,1,77}]}}],
                                            parse(" func1 ( abc ) do | parm | 77 end ")),
    ?_assertEqual([{local_call,1,func1,[{string,1,"xyz"}],{lambda,1,[],[{integer,2,77}]}}],
                                            parse(" func1 ( \"xyz\" ) do \n 77 \n end \n ")),
    % Native Calls
    ...
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[{integer,1,23}],{nil,1}}],
                                            parse(" Clas.func( 23 ) ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[],{lambda,1,[],[]}}],
                                            parse(" Clas.func {} ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[],{lambda,1,[],[{var,1,abc}]}}],
                                            parse(" Clas.func { abc } ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[{var,1,abc}],
                                                         {lambda,1,[],[{var,1,xyz}]}}],
                                            parse(" Clas.func ( abc ) { xyz } ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[],{lambda,1,[],[{integer,1,23}]}}],
                                            parse(" Clas.func {23} ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[],{lambda,1,[],[{integer,1,23}]}}],
                                            parse(" Clas.func do 23 end ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[{var,1,abc}],
                                                         {lambda,1,[{var,1,stu}],[{var,1,xyz}]}}],
                                            parse(" Clas.func ( abc ) { | stu | xyz } ")),
    ?_assertEqual([{remote_call,1,{module_name,1,'Clas'},func,[],
                                                         {lambda,1,[{var,1,stu}],[{integer,1,23}]}}],
                                            parse(" Clas.func do | stu | 23 end ")),
%    ?_assertEqual(,
%                                            parse(" Clas.func () {} ")),
%    ?_assertEqual(,
