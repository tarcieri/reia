...
task :compiler => %w[src/reia/compiler/reia_scan.beam src/reia/compiler/reia_parse.beam]
...
file "src/reia/compiler/reia_parse.beam" => "src/reia/compiler/reia_parse.erl"
file "src/reia/compiler/reia_parse.erl" => "src/reia/compiler/reia_parse.yrl" do
  sh "erl -eval 'yecc:file(\"src/reia/compiler/reia_parse.yrl\")' -noshell -s init stop"
end
...
task :clean do
  ...
  rm_f 'src/reia/compiler/reia_parse.erl'
  rm_f 'src/reia/compiler/reia_parse.beam'
end
